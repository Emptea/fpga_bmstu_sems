...
```
quartus_sh -t tcl/qsh_create_project.tcl -project fir_10khz -folder quartus -src_exc testbench software -top fir_10khz_top -tb fir_10khz_tb -board DE2_Default
```
Пример минимальной команды создания проекта Quartus для данного проекта:
```
quartus_sh -t tcl/qsh_create_project.tcl -project fir_10khz -top fir_10khz_top
```

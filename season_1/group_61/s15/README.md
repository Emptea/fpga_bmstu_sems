...
```
quartus_sh -t tcl/qsh_create_project.tcl -project pow5 -folder quartus -src_exc testbench software -top pow5_top -tb pow5_tb -board DE2_Default
```
Пример минимальной команды создания проекта Quartus для данного проекта:
```
quartus_sh -t tcl/qsh_create_project.tcl -project pow5 -top pow5_top
```

...
```
quartus_sh -t tcl/qsh_create_project.tcl -project ram -folder quartus -src_exc testbench software -top ram -tb ram_tb -board DE2_Default
```
Пример минимальной команды создания проекта Quartus для данного проекта:
```
quartus_sh -t tcl/qsh_create_project.tcl -project ram -top ram
```
